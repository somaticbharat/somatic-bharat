...
const translations = {
  en: {
    ...
    ctaHero: "Discover yourself with the 3-min SOMATIC quiz",
  ...
  as: {
    ...
    login: "লগ-ইন",
    logout: "লগ-আউট",
    auditBtn: "ছ’মেটিক কুইজ আৰম্ভ কৰক",
    ...
    ctaHero: "৩-মিনিটৰ ছ’মেটিক কুইজৰ জৰিয়তে নিজক আৱিষ্কাৰ কৰক",
